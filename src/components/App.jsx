...
const App = () => {
  ...
  const handleRouteChange = (current_place) => {
    let url = "";

    switch (current_place) {
      case "TV Shows":
        url = `https://api.themoviedb.org/3/search/tv?query=${value}&include_adult=false&language=en-US&page=1`;
        break;
      default:
  ...
  useEffect(() => {
    ...
    handleRouteChange(browserPath.pathname);
  }, [location]);
